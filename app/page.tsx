          ...
          <div className="text-center mb-16">
            ...
            <div className="mb-8">
              ...
              >
                ...
                <div>
                  <div className="text-white font-bold tracking-wider">VIEW_SOURCE_CODE</div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-400 leading-relaxed mb-4 tracking-wide">
                      NO COMPLEX IDS OR RANDOM STRINGS. JUST TYPE THE CITY NAME WITH DASHES FOR
                      SPACES. /EXPERIENCE/NEW-YORK, /EXPERIENCE/LOS-ANGELES,
              ...
              <CardContent className="p-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-400 leading-relaxed mb-4 tracking-wide">
                      EVERY CITY PAGE SHOWS THE REAL-TIME DISTANCE TO THE INTERNATIONAL SPACE
                      STATION. GET EXCITED ALERTS WHEN THE ISS FLIES WITHIN 500KM OF YOUR CHOSEN
                      CITY!
                    </p>
